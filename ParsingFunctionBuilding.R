ParserJanuary2010 = function(DataIn, DataDictionaryIn) {
  ...
  # HURRESPLI gives the line number (from the variable pulineno) of the respondent who is providing the survey answers for the household. 
  # One respondent can answer the survey questions for all members of the household.
  ...
  # PULAY6M tells if the respondent's employer has given the respondent any indication that they will be recalled to work in the next six months. 
  ...
  # PULAYAVR tells why the respondent would not have been available for work last week had they been recalled by their employer. 
  # Only asked if the respondent has reported being on temporary layoff.
  ...
  # The following variables discuss the ways that an unemployed person is looking for work. There are three tracks of six variables 
  # (PELKM1-PULKM6, PULKDK1-PULKDK6, PULKPS1-PULKPS6). I am not sure why (I think they come from different questioning tracks). 
  # On each track, the second variable should only have a response if the first does, and so on.
  AA$pelkm1 = factor(AA$pelkm1, levels = c(-3:-1, 1:13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                    ...
                                                                    "Attended job training programs/courses", "Nothing", "Other passive"))
  
  AA$pulkm2 = factor(AA$pulkm2, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                        "Contacted public employment agency", "Contacted private employment agency", 
                                                                        "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                        "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                        "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkm3 = factor(AA$pulkm3, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                        "Contacted public employment agency", "Contacted private employment agency", 
                                                                        "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                        "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                        "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkm4 = factor(AA$pulkm4, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                        "Contacted public employment agency", "Contacted private employment agency", 
                                                                        "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                        "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                        "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkm5 = factor(AA$pulkm5, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                        "Contacted public employment agency", "Contacted private employment agency", 
                                                                        "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                        "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                        "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkm6 = factor(AA$pulkm6, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                        "Contacted public employment agency", "Contacted private employment agency", 
                                                                        "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                        "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                        "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkdk1 = factor(AA$pulkdk1, levels = c(-3:-1, 1:13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                      "Contacted public employment agency", "Contacted private employment agency", 
                                                                      "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                      "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                      "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkdk2 = factor(AA$pulkdk2, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                          "Contacted public employment agency", "Contacted private employment agency", 
                                                                          "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                          "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                          "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkdk3 = factor(AA$pulkdk3, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                          "Contacted public employment agency", "Contacted private employment agency", 
                                                                          "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                          "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                          "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkdk4 = factor(AA$pulkdk4, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                          "Contacted public employment agency", "Contacted private employment agency", 
                                                                          "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                          "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                          "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkdk5 = factor(AA$pulkdk5, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                          "Contacted public employment agency", "Contacted private employment agency", 
                                                                          "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                          "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                          "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkps2 = factor(AA$pulkps2, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                          "Contacted public employment agency", "Contacted private employment agency", 
                                                                          "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                          "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                          "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkps3 = factor(AA$pulkps3, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                          "Contacted public employment agency", "Contacted private employment agency", 
                                                                          "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                          "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                          "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkps4 = factor(AA$pulkps4, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                          "Contacted public employment agency", "Contacted private employment agency", 
                                                                          "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                          "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                          "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkps5 = factor(AA$pulkps5, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                          "Contacted public employment agency", "Contacted private employment agency",
                                                                          "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                          "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                          "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  AA$pulkps6 = factor(AA$pulkps6, levels = c(-3:-1, 1:11, 13), labels = c("Refused", "Don't Know", NA, "Contacted employer directly/Interview", 
                                                                          "Contacted public employment agency", "Contacted private employment agency", 
                                                                          "Contacted friends or relatives", "Contacted school/university empl center", 
                                                                          "Sent out resumes/filled out application", "Checked union/professional registers", 
                                                                          "Placed or answered ads", "Other active", "Looked at ads", 
  ...
  # PELKAVL gives the respondent's answer to the question "Last week, could you have started a job if one had been offered?" 
  # It is only asked of those who are unemployed and reported looking for work (pelkm1 = 1-13)
  ...
  # PUJHDP1O tells whether the respondent did any of that work in the last 4 weeks. 
  # (I am assuming it is reporting data only for those people with pehjwko = 1, but it does not specifically say.)
  ...
  # PUIODP1 tells whether the respondent is working at the same job as they were the previous month. 
  # It is presumably not asked of those in the first month in the sample. Specific Employer names will not appear for any respondent.
  AA$puiodp1 = factor(AA$puiodp1, levels = c(-3:-1, 1, 2), labels = c("Refused", "Don't Know", NA, "Yes", "No"))
  
  
  # PUIODP2 tells whether the respondent's "job activities and duties" have changed since the previous month. 
  # It is presumably not asked of those in the first month in the sample.
  AA$puiodp2 = factor(AA$puiodp2, levels = c(-3:-1, 1, 2), labels = c("Refused", "Don't Know", NA, "Yes", "No"))
  
  # PUIODP3 tells whether the respondent's previously recorded occupation and activites accurately describe their current job. 
  ...
  # PRCOW1-PRCOW2 are recodes for the respondent that summarizes the class of worker for the respondent's jobs. 
  ...
  # PEERNUOT gives the respondent's answer to the question "Do you usually receive overtime pay, tips, or commissions at your job?" 
  ...
  # It only reports data for those who report being in high school or college/university (peschlvl = 1-2).
  ...
  # independent estimate of the number of veterans that is supplied by the VA.
  AA$pwvetwgt[AA$pwvetwgt <= -1] = NA
  
  # PRCHLD tells whether the respondent has minor children residing in the household with them.
  AA$prchld = factor(AA$prchld, levels = c(-3:15), labels = c("Refused", "Don't Know", "NIU (Not a parent)", "No own children under 18 years of age", 
                                                              "All own children 0-2 years of age", "All own children 3-5 years of age", 
                                                              "All own children 6-13 years of age", "All own children 14-17 years of age", 
                                                              ...
                                                              "Own children 3-5 and 6-13 years of age (none 0-2 or 14-17)", 
                                                              "Own children 3-5 and 14-17 years of age (none 0-2 or 6-13)", 
                                                              "Own children 6-13 and 14-17 years of age (none 0-5)", 
                                                              "Own children 0-2, 3-5, and 6-13 years of age (none 14-17)", 
                                                              "Own children 0-2, 3-5, and 14-17 years of age (none 6-13)", 
                                                              "Own children 0-2, 6-13, and 14-17 years of age (none 3-5)", 
  ...
  # This provides the most detailed occupation code for the respondent's primary job. The four digit code (insert leading 0s as necessary) 
