ParserJanuary1998 = function(AA, DictionaryIn) {
  ...
  AA$hufinal = factor(AA$hufinal, 
                      ...
                      labels = c(NA, "New interview - Not contacted", "Fully complete CATI interview", "Partially completed CATI interview", "Labor force complete, Supplement incomplete - CATI", "HH occupied entirely by Armed Forces members",
                                 ...
                                 "Other - Specify"))
  AA$huspnish = factor(AA$huspnish, levels = c(-3:-1, 1), labels = c("Refused", "Don't Know", NA, "Spanish only language spoken"))
  ...
  AA$hephoneo = factor(AA$hephoneo, levels = c(-1:2), labels = c(NA, "Unknown", "Telephone interview acceptable", "Telephone interview not acceptable"))
  ...
  AA$huinttyp = factor(AA$huinttyp, levels = -3:2, labels = c(NA, "Noninterview/Indeterminate", "Personal", "Telephone"))
  ...
  AA$prtage = factor(AA$prtage, levels = -1:90, labels = c(NA, str_c(0:89, " years old"), "90+ years old"))
  AA$prtfage = factor(AA$prtfage, levels = -1:1, labels = c(NA, "No top code", "Top coded value for age"))
  ...
  AA$perace = factor(AA$perace, levels = c(-1, 1:4), labels = c(NA, "White", "Black", "American Indian, Aleut, Eskimo", "Asian or Pacific Islander"))
